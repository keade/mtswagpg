...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { designer: @trade.designer, developer: @trade.developer, image: @trade.image, others: @trade.others, title: @trade.title }
    end
  ...
  test "should update trade" do
    put :update, id: @trade, trade: { designer: @trade.designer, developer: @trade.developer, image: @trade.image, others: @trade.others, title: @trade.title }
    assert_redirected_to trade_path(assigns(:trade))
  end
